...
describe("Testing restClient", function(){
	describe("instanciation tests", function(){
		it("should instanciate with one config object parameter", function(){
			restInit(config);
		});

		it("should instanciate with one config object parameter, and accessToken", function(){
			restInit(config, "accesstokenblahblahblah");
		});

		it("should instanciate with two params; namspaces, and creds.", function(){
			restInit(config.namespaces, config.creds);
		});

		it("should instanciate with two params; namspaces, and creds, and accessToken", function(){
			restInit(config.namespaces, config.creds, "accesstokenblahblahblah");
		});
